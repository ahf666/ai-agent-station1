package cn.ao666.ai.domain.agent.service.execute.flow.step;

import cn.ao666.ai.domain.agent.model.entity.AutoAgentExecuteResultEntity;
import cn.ao666.ai.domain.agent.model.entity.ExecuteCommandEntity;
import cn.ao666.ai.domain.agent.model.valobj.AiAgentClientFlowConfigVO;
import cn.ao666.ai.domain.agent.model.valobj.enums.AiClientTypeEnumVO;
import cn.ao666.ai.domain.agent.service.execute.flow.step.factory.DefaultFlowAgentExecuteStrategyFactory;
...
public class Step1McpToolsAnalysisNode extends AbstractExecuteSupport {
    ...
    protected String doApply(ExecuteCommandEntity requestParameter, DefaultFlowAgentExecuteStrategyFactory.DynamicContext dynamicContext) throws Exception {
        ...
        // 使用MCP工具分析ChatClient来执行MCP工具分析步骤
